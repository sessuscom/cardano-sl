...
The `spendingPassword` is optional but highly recommended. It is a 64-byte hex-encoded hash of
a secure passphrase that will be required for sensitive operations on the wallet. You can
create such hash using a *SHA256* or *BLAKE2b* hashing algorithms.
